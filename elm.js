...
var $author$project$Shireen$Tick = F2(
	function (a, b) {
		return {$: 'Tick', a: a, b: b};
	});
...
var $author$project$Shireen$init = {time: 0};
var $author$project$Shireen$update = F2(
	function (msg, model) {
		var t = msg.a;
...
var $author$project$Shireen$cecilia = $MacCASOutreach$graphicsvg$GraphicSVG$group(
	_List_fromArray(
		[
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
				A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 137, 55, 33),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-56.05, 31.025),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-62.42, 32.828),
							_Utils_Tuple2(-64.74, 23.831)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-66.35, 15.627),
							_Utils_Tuple2(-63.85, 9.1428)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-63.01, 2.9367),
							_Utils_Tuple2(-66.54, -0.749)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-63.59, -2.230),
							_Utils_Tuple2(-61.15, 1.6487)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-63.27, -1.199),
							_Utils_Tuple2(-63.55, -4.046)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-57.05, -5.829),
							_Utils_Tuple2(-53.35, 1.9484)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-51.82, 5.0251),
							_Utils_Tuple2(-52.45, 10.341)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-53.05, 15.587),
							_Utils_Tuple2(-53.65, 20.833)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-54.85, 25.929),
							_Utils_Tuple2(-56.05, 31.025))
						])))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			...
			A2(
				...
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-41.36, -49.91),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-43.03, -53.77),
							_Utils_Tuple2(-40.46, -55.60)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-31.48, -57.93),
							_Utils_Tuple2(-28.17, -55.90)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-26.56, -53.73),
							_Utils_Tuple2(-29.07, -52.00)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-32.07, -50.79),
							_Utils_Tuple2(-35.07, -49.01)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-38.07, -48.71),
							_Utils_Tuple2(-41.06, -48.41)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-41.21, -49.16),
							_Utils_Tuple2(-41.36, -49.91))
						])))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			...
			A2(
				...
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-53.95, -50.21),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-56.75, -56.23),
							_Utils_Tuple2(-53.35, -58.30)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-47.27, -60.13),
							_Utils_Tuple2(-45.26, -57.40)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-44.45, -54.88),
							_Utils_Tuple2(-46.76, -53.20)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-47.41, -51.70),
							_Utils_Tuple2(-48.26, -50.21)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-50.51, -49.61),
							_Utils_Tuple2(-52.75, -49.01)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-53.50, -49.61),
							_Utils_Tuple2(-53.95, -50.21))
						])))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 249, 101, 103),
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-53.95, -50.21),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-52.45, -50.95),
						_Utils_Tuple2(-50.96, -50.81)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-52.31, -50.88),
						_Utils_Tuple2(-52.75, -52.00)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-53.14, -52.67),
						_Utils_Tuple2(-52.45, -52.30)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-52.78, -53.51),
						_Utils_Tuple2(-52.15, -53.80)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-53.30, -54.39),
						_Utils_Tuple2(-53.65, -55.90)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-54.96, -55.30),
						_Utils_Tuple2(-55.15, -54.70)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-54.97, -52.05),
						_Utils_Tuple2(-53.95, -50.21))
					]))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-41.06, -50.21),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-38.68, -51.44),
						_Utils_Tuple2(-36.27, -49.91)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-37.14, -50.50),
						_Utils_Tuple2(-37.17, -52.00)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-35.83, -52.95),
						_Utils_Tuple2(-34.17, -52.90)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-35.01, -54.24),
						_Utils_Tuple2(-34.77, -54.70)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-38.22, -54.16),
						_Utils_Tuple2(-41.66, -52.90)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-40.94, -51.70),
						_Utils_Tuple2(-41.06, -50.21))
					]))),
			A3(
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-54.85, -55.00),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-51.70, -59.14),
						_Utils_Tuple2(-45.86, -56.20))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.3),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-53.35, -56.20),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-52.64, -52.63),
						_Utils_Tuple2(-46.76, -54.10))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.3),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-51.85, -54.10),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-52.47, -53.50),
						_Utils_Tuple2(-52.45, -52.90)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-51.19, -51.49),
						_Utils_Tuple2(-47.96, -52.00)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-47.75, -51.55),
						_Utils_Tuple2(-48.26, -51.11)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-51.14, -50.66),
						_Utils_Tuple2(-52.45, -51.70)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-52.66, -52.15),
						_Utils_Tuple2(-52.15, -52.60))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.3),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-35.67, -49.91),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-36.98, -50.27),
						_Utils_Tuple2(-37.17, -51.70)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-36.89, -52.42),
						_Utils_Tuple2(-35.97, -52.30)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-35.32, -50.75),
						_Utils_Tuple2(-33.87, -50.21)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-35.28, -50.69),
						_Utils_Tuple2(-35.97, -52.00)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-35.24, -52.79),
						_Utils_Tuple2(-33.87, -52.90)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-33.47, -51.53),
						_Utils_Tuple2(-31.47, -51.40))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.3),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-33.87, -52.60),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-34.80, -53.40),
						_Utils_Tuple2(-34.77, -55.00)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-38.22, -54.43),
						_Utils_Tuple2(-41.66, -52.90)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-32.44, -56.55),
						_Utils_Tuple2(-28.17, -53.80))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.5),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
				A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 75, 98, 137),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-51.85, -20.83),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-52.36, -35.07),
							_Utils_Tuple2(-54.55, -49.31)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-50.89, -51.42),
							_Utils_Tuple2(-47.06, -50.21)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-44.24, -38.66),
							_Utils_Tuple2(-43.46, -27.12)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-41.40, -38.22),
							_Utils_Tuple2(-42.26, -49.31)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-38.26, -51.33),
							_Utils_Tuple2(-35.07, -49.31)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-33.68, -35.07),
							_Utils_Tuple2(-35.37, -20.83)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-40.91, -19.33),
							_Utils_Tuple2(-46.46, -17.83)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-49.31, -19.33),
							_Utils_Tuple2(-51.85, -20.83))
						])))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
				A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 253, 171, 119),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-45.26, 6.7447),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-44.68, 4.4755),
							_Utils_Tuple2(-46.46, 4.6463)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-57.69, -3.512),
							_Utils_Tuple2(-56.65, -23.23)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-58.25, -30.05),
							_Utils_Tuple2(-54.85, -32.52)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-53.41, -33.49),
							_Utils_Tuple2(-53.05, -32.82)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-51.12, -33.04),
							_Utils_Tuple2(-51.55, -31.02)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-51.45, -29.07),
							_Utils_Tuple2(-52.15, -27.12)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-52.00, -29.41),
							_Utils_Tuple2(-50.66, -30.42)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-48.87, -28.00),
							_Utils_Tuple2(-51.85, -22.63)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-51.72, -21.73),
							_Utils_Tuple2(-52.15, -20.83)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-43.76, -20.83),
							_Utils_Tuple2(-35.37, -20.83)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-35.82, -25.38),
							_Utils_Tuple2(-33.87, -27.72)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-32.54, -27.29),
							_Utils_Tuple2(-32.97, -25.03)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-32.79, -28.09),
							_Utils_Tuple2(-34.17, -29.52)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-34.11, -30.68),
							_Utils_Tuple2(-31.77, -29.52)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-30.12, -26.38),
							_Utils_Tuple2(-32.07, -20.23)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-32.03, -14.77),
							_Utils_Tuple2(-33.27, -8.843)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-36.42, -2.548),
							_Utils_Tuple2(-39.56, 3.7470)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-39.56, 3.7470),
							_Utils_Tuple2(-39.56, 3.7470)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-39.66, 4.1967),
							_Utils_Tuple2(-40.16, 4.6463)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-38.37, 8.2435),
							_Utils_Tuple2(-36.57, 11.840)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-41.06, 9.2927),
							_Utils_Tuple2(-45.26, 6.7447))
						])))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			...
			A2(
				...
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-50.06, 10.641),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-56.28, 10.200),
							_Utils_Tuple2(-56.95, 14.838)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-55.41, 21.868),
							_Utils_Tuple2(-50.36, 15.737)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-49.85, 17.836),
							_Utils_Tuple2(-50.66, 19.934)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-51.55, 23.231),
							_Utils_Tuple2(-52.45, 26.529)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-46.76, 28.777),
							_Utils_Tuple2(-41.06, 31.025)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-38.81, 32.524),
							_Utils_Tuple2(-36.57, 34.023)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-32.82, 31.025),
							_Utils_Tuple2(-29.07, 28.028)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-29.07, 24.730),
							_Utils_Tuple2(-29.07, 21.433)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-29.46, 18.485),
							_Utils_Tuple2(-28.17, 16.337)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-27.35, 10.740),
							_Utils_Tuple2(-32.37, 6.7447)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-36.12, 4.5955),
							_Utils_Tuple2(-39.86, 4.6463)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-47.19, 6.5040),
							_Utils_Tuple2(-50.06, 10.641))
						])))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-55.15, 16.037),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-53.73, 17.808),
						_Utils_Tuple2(-51.55, 13.939))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-52.45, 15.138),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-53.61, 12.949),
						_Utils_Tuple2(-52.45, 12.440))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.5),
			...
			A2(
				...
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-56.65, 16.936),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-60.20, 22.181),
							_Utils_Tuple2(-55.75, 31.025)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-50.15, 39.462),
							_Utils_Tuple2(-39.86, 38.220)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-28.97, 36.824),
							_Utils_Tuple2(-27.27, 26.829)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-26.41, 22.601),
							_Utils_Tuple2(-29.07, 21.133)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-29.57, 29.329),
							_Utils_Tuple2(-36.27, 31.925)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-39.76, 25.408),
							_Utils_Tuple2(-47.06, 22.932)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-44.75, 25.489),
							_Utils_Tuple2(-44.96, 29.526)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-45.32, 22.680),
							_Utils_Tuple2(-50.36, 20.234)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-49.84, 23.231),
							_Utils_Tuple2(-50.36, 26.229)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-49.89, 23.231),
							_Utils_Tuple2(-50.66, 20.234)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-49.77, 18.135),
							_Utils_Tuple2(-50.36, 16.037)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-51.38, 18.646),
							_Utils_Tuple2(-54.85, 18.735)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-56.39, 18.456),
							_Utils_Tuple2(-56.65, 16.936))
						])))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(1),
			A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 65, 29, 17),
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-43.76, 26.229),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-42.57, 27.979),
						_Utils_Tuple2(-39.26, 27.128))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(1),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-35.07, 27.428),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-32.72, 28.659),
						_Utils_Tuple2(-31.17, 25.929))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-41.06, 11.540),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-37.87, 9.4409),
						_Utils_Tuple2(-33.87, 11.540))
					]))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 49, 16, 6),
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-45.56, 19.934),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-42.56, 20.683),
						_Utils_Tuple2(-39.56, 21.433)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-39.56, 21.583),
						_Utils_Tuple2(-39.56, 21.733)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-40.17, 23.542),
						_Utils_Tuple2(-42.86, 23.231)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-45.45, 22.483),
						_Utils_Tuple2(-45.56, 19.934))
					]))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-35.07, 21.433),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-32.67, 21.283),
						_Utils_Tuple2(-30.27, 21.133)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-30.35, 23.162),
						_Utils_Tuple2(-32.67, 23.231)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-34.77, 23.252),
						_Utils_Tuple2(-35.07, 21.433))
					]))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-41.96, 15.737),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-44.47, 16.516),
						_Utils_Tuple2(-45.26, 18.735)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-45.22, 22.063),
						_Utils_Tuple2(-42.26, 22.632)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-38.96, 22.203),
						_Utils_Tuple2(-39.26, 19.334)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-38.70, 15.696),
						_Utils_Tuple2(-41.96, 15.737))
					]))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-33.27, 16.337),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-34.99, 17.285),
						_Utils_Tuple2(-35.07, 19.634)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-34.70, 21.963),
						_Utils_Tuple2(-32.97, 22.932)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-30.16, 22.853),
						_Utils_Tuple2(-30.27, 19.934)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-30.18, 15.545),
						_Utils_Tuple2(-33.27, 16.337))
					]))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 53, 28, 18),
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-40.46, 17.236),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-41.87, 17.565),
						_Utils_Tuple2(-41.96, 19.334)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-41.96, 20.834),
						_Utils_Tuple2(-40.76, 21.133)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-39.42, 20.794),
						_Utils_Tuple2(-39.56, 19.334)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-39.48, 17.695),
						_Utils_Tuple2(-40.46, 17.236))
					]))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$filled,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-31.77, 17.836),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-32.93, 18.235),
						_Utils_Tuple2(-32.97, 19.634)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-33.03, 21.113),
						_Utils_Tuple2(-31.77, 21.433)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-30.43, 21.333),
						_Utils_Tuple2(-30.57, 19.634)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-30.70, 18.035),
						_Utils_Tuple2(-31.77, 17.836))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-35.97, 17.236),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-34.18, 17.357),
						_Utils_Tuple2(-33.87, 16.037)),
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-33.71, 14.298),
						_Utils_Tuple2(-35.07, 14.238))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$addOutline,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.5),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
				A3($MacCASOutreach$graphicsvg$GraphicSVG$rgb, 240, 166, 98),
				A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$curve,
					_Utils_Tuple2(-46.46, 4.6463),
					_List_fromArray(
						[
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-54.59, 1.6611),
							_Utils_Tuple2(-56.65, -7.644)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-54.49, -10.24),
							_Utils_Tuple2(-48.86, -10.04)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-47.76, -7.264),
							_Utils_Tuple2(-47.66, -2.847)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-47.51, -10.22),
							_Utils_Tuple2(-50.36, -10.04)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-51.93, -15.92),
							_Utils_Tuple2(-51.85, -21.13)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-42.16, -23.53),
							_Utils_Tuple2(-34.47, -20.53)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-35.80, -15.61),
							_Utils_Tuple2(-35.37, -9.742)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-34.57, -6.295),
							_Utils_Tuple2(-35.97, -1.049)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-34.89, -5.096),
							_Utils_Tuple2(-35.37, -9.142)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-33.37, -9.123),
							_Utils_Tuple2(-32.37, -7.943)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-31.96, 0.6517),
							_Utils_Tuple2(-38.66, 3.4473)),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
							_Utils_Tuple2(-40.77, -4.043),
							_Utils_Tuple2(-46.46, 4.6463))
						])))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-53.95, -28.02),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-54.46, -31.11),
						_Utils_Tuple2(-53.05, -32.52))
					]))),
			A3(
			$MacCASOutreach$graphicsvg$GraphicSVG$outlined,
			$MacCASOutreach$graphicsvg$GraphicSVG$solid(0.5),
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$curve,
				_Utils_Tuple2(-55.75, -28.02),
				_List_fromArray(
					[
						A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$Secret$Pull,
						_Utils_Tuple2(-55.91, -30.95),
						_Utils_Tuple2(-54.55, -32.52))
					])))
		]));
var $author$project$Shireen$myShapes = function (model) {
	return _List_fromArray(
		[$author$project$Shireen$cecilia]);
};
var $author$project$Shireen$view = function (model) {
	return A3(
		$MacCASOutreach$graphicsvg$GraphicSVG$collage,
		192,
		128,
		$author$project$Shireen$myShapes(model));
};
var $author$project$Shireen$main = A2(
	$MacCASOutreach$graphicsvg$GraphicSVG$App$gameApp,
	$author$project$Shireen$Tick,
	{model: $author$project$Shireen$init, title: 'Starfish', update: $author$project$Shireen$update, view: $author$project$Shireen$view});
_Platform_export({'Shireen':{'init':$author$project$Shireen$main(
